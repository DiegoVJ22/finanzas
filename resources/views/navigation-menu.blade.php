<nav x-data="{ open: false }"
    class="fixed w-full z-50 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-md">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 lg:flex">
                    ...
                    <x-nav-link href="{{ route('datos.index') }}" :active="request()->routeIs('datos.index')">
                        {{ __('Datos') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('nof.index') }}" :active="request()->routeIs('nof.index')">
                        {{ __('NOF') }}
                    </x-nav-link>
